...
export function ProfilePage() {
    ...
    if (loading) {
        return (
            <div style={{ display: 'flex', height: '100vh', alignItems: 'center', justifyContent: 'center', background: isDark ? '#0f172a' : '#f8fafc' }}>
    ...
    return (
        ...
        .pp-edit-btn { transition: all .25s cubic-bezier(.34,1.56,.64,1); }
        .pp-edit-btn:hover { transform: translateY(-2px); box-shadow: 0 8px 24px rgba(0,0,0,0.18); }
                                ...
                                <div style={{ display: 'flex', alignItems: 'center', gap: 24 }}>
                                    ...
                                    <div className="pp-hero-text" style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
                                        ...
                                        <p style={{ fontSize: 13, color: 'rgba(255,255,255,0.65)', margin: 0, fontWeight: 500 }}>
                                            @{user?.username || t('user_label')}
                                        </p>
                                        <div style={{
                                            display: 'inline-flex', alignItems: 'center', gap: 5, marginTop: 4, width: 'fit-content',
                                            padding: '4px 12px', borderRadius: 999,
                                            background: 'rgba(255,255,255,0.15)', border: '1px solid rgba(255,255,255,0.25)',
                                            fontSize: 9, fontWeight: 800, letterSpacing: '.14em', textTransform: 'uppercase', color: '#fff',
                                        }}>
                        ...
                        <div style={{ padding: '32px 40px 36px' }}>
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 24 }}>
                                <div style={{
                                    ...
                                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                                    boxShadow: '0 4px 14px rgba(93,123,147,0.32)', flexShrink: 0,
                                }}>
                                ...
                                <div>
                                    ...
                                    <p style={{ fontSize: 11, color: muted, margin: '1px 0 0' }}>
                                        {isEditing ? t('edit_info_hint') : t('account_info')}
                                    </p>
                                </div>
                                <div style={{
                            ...
                            {!isEditing ? (
                                <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                                    <div className="pp-view-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
                                        {[
                                            { icon: <Mail size={18} color="#5D7B93" strokeWidth={2} />, label: t('email_address'), value: formData.email },
                                            { icon: <Phone size={18} color="#5D7B93" strokeWidth={2} />, label: t('phone_number'), value: formData.phone || t('not_linked') },
                                        ].map(item => (
                                            <div key={item.label} className="pp-info-item" style={{
                                    ...
                                    {/* Bio */}
                                    <div className="pp-info-item" style={{
                                        display: 'flex', alignItems: 'flex-start', gap: 14,
                                        padding: '16px 18px', borderRadius: 20,
                                        background: innerBg, border: `1px solid ${innerBdr}`,
                                    }}>
                                ...
                                <form onSubmit={handleSave}>
                                    <div className="pp-grid-2" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, marginBottom: 16 }}>
                                        ...
                                        <div>
                                            ...
                                            <input type="text" className={inputClass} placeholder="Arabboyev"
                                    ...
                                    <div className="pp-grid-2" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, marginBottom: 16 }}>
                                        <div>
                                            ...
                                            <div style={{ position: 'relative' }}>
                                                <Mail size={16} color="#A2B3C1" strokeWidth={2} style={{ position: 'absolute', left: 16, top: '50%', transform: 'translateY(-50%)', pointerEvents: 'none' }} />
                                                <input type="email" className={inputClass} style={{ paddingLeft: 44 }} placeholder="botir@example.com"
                                        ...
                                        <div>
                                            ...
                                            <div style={{ position: 'relative' }}>
                                                <Phone size={16} color="#A2B3C1" strokeWidth={2} style={{ position: 'absolute', left: 16, top: '50%', transform: 'translateY(-50%)', pointerEvents: 'none' }} />
                                                <input type="text" className={inputClass} style={{ paddingLeft: 44 }} placeholder="+998 90 000 00 00"
                                    ...
                                    {/* Buttons */}
                                    <div style={{ display: 'flex', gap: 12, paddingTop: 20, borderTop: `1px solid ${isDark ? 'rgba(255,255,255,0.05)' : '#f1f5f9'}` }}>
