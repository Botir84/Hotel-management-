...
export function CheckInModal({ isOpen, onClose, room, onSuccess }: any) {
  ...
  return createPortal(
    <div style={{ position: 'fixed', inset: 0, zIndex: 9999, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '16px', background: 'rgba(2,6,23,0.85)', backdropFilter: 'blur(12px)', WebkitBackdropFilter: 'blur(12px)' }}>
      <div className={`${isDark ? 'bg-[#0f172a]' : 'bg-white'} border ${isDark ? 'border-white/5' : 'border-slate-200'} w-full max-w-5xl rounded-[2.5rem] shadow-2xl overflow-hidden flex h-[90vh]`}>
        ...
        <div className="flex-1 flex flex-col min-w-0">
          <div className={`px-10 py-6 flex justify-between items-center border-b ${isDark ? 'border-white/5' : 'border-slate-100'}`}>
            <h3 className={`text-xl font-black uppercase tracking-widest ${isDark ? 'text-white' : 'text-slate-800'}`}>
              {t('checkin_title')}
            </h3>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="col-span-2 md:col-span-1">
                  ...
                  <div className="relative">
                    ...
                    <input className={`${inputClass} pl-12`} placeholder="John Doe"
                ...
                <div className="col-span-2 md:col-span-1">
                  ...
                  <div className="relative">
                    ...
                    <input className={`${inputClass} pl-12`} placeholder="AB1234567"
              ...
              <div className={`p-6 rounded-[2rem] border transition-all
                ...
                <div className="flex justify-between items-center">
                  <div className="flex items-center gap-3">
                    ...
                    <h4 className="text-lg font-black uppercase tracking-widest text-[#5D7B93]">{t('total_amount')}</h4>
                  </div>
          ...
          <div className={`p-8 border-t mt-auto ${isDark ? 'border-white/5' : 'border-slate-100'}`}>
            <div className="flex gap-4 w-full">
              <button onClick={onClose}
                className={`flex-1 min-h-[60px] rounded-xl font-black uppercase text-[10px] tracking-widest transition-all
